...
<head>
  ...
  <title>Login Dokumentasi Covid</title>
  <!-- plugins:css -->
        ...
        <div class="row w-100">
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left p-5">
              ...
              <h4 class="font-weight-light">Sistem Informasi Keperawatan</h4>
              <form class="pt-3" id="form_login" action="{{ route('login') }}" method="POST">
                @csrf
